...
$popup_data = CX_UPDATE_POPUP_CONTENT; // get Data from update class,
...
<style>
    ...
    .update-close-popup:hover,  .update-close-popup:disabled {
    ...
    <span class="premio-update-popup-bg-shape"></span>
       ...
       <div class="remio-update-popup-content">
            ...
            <div class="popup-update-btn-wrap">
                <button href="javascript:;" class="update-popup-btn submit-popup yes"> <?php esc_html_e('Count Me In', 'coupon-x')?>
                    <span class="icon">
                ...
                <button href="javascript:;" class="update-popup-btn update-close-popup no"> <?php esc_html_e('Maybe Later', 'coupon-x')?> </button>
            </div>
...
<script>
	jQuery(document).ready(function($) {
		...
		$(document).on("click", ".update-popup-btn", function () { 
            ...
            $('#suggestion').html('');
            var email = $('#couponx_update_email').val();  
			...
			$.ajax({
                ...
                data: {
                    ...
                    status: updateStatus,
                    email: email,
                    nonce: jQuery("#coupon_x_signup_nonce").val()
                },
                type: 'post',
				cache: false,
				success: function () {
        ...
        jQuery(document).on('blur','#couponx_update_email', function(event) {            
            msemailcheck();
        });
		
		function msemailcheck() {
        
			jQuery('#couponx_update_email').mailcheck({
        ...
        $("#couponx_update_email").emailautocomplete({            
        ...
        $(document).on("click", "#suggestion i", function (){
            $("#couponx_update_email").val($(this).text());
