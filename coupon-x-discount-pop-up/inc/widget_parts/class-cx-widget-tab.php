...
class Cx_Widget_Tab
{
        ...
        <?php esc_html_e('Name Your Widget', 'coupon-x'); ?> 
                ...
                <div class='row'>
                    <div class='row-elements half color-row'>
                        <label> 
        <?php esc_html_e('Icon background color', 'coupon-x'); ?>
        ...
        ?>
                                ...
                                <li>
                                    <label class="upload">
                                        ...
                                        ?>
                                        />
                                        <input type="hidden" name="cx_settings[tab][tab_custom_icon]" id="tab_custom_icon" value="<?php echo esc_attr($settings['tab_custom_icon']); ?>" />
                        ...
                        <ul class='custom-list'>
                            ...
                            <li>
                                <label> 
                                    ...
                                    <span class="icon label-tooltip coupon-tab-design" title="<?php esc_html_e('Hide the icon after a user has converted, which means copied the coupon code or submitted their email.', 'coupon-x'); ?>">
                ...
                <div class='row show-attention-effect <?php echo ($settings['effect'] == "none") ? 'hide' : '' ?>'>
                    <div class='row-elements full'>
                        ...
                        <ul class='custom-list'>
                            <li>
                                <label>
                                    <input type='radio' name='cx_settings[tab][show_attention]' value='1' <?php echo checked(esc_attr($showAttention), 1, false); ?>>
                                    <?php esc_html_e('Always', 'coupon-x'); ?>
                                    <span class="icon label-tooltip coupon-tab-design" title="<?php esc_html_e('Display the attention effect at all times, even if the visitor has already clicked on the icon.', 'coupon-x'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type='radio' name='cx_settings[tab][show_attention]' value='2' <?php echo checked(esc_attr($showAttention), 2, false); ?>>
    ...
    public function render_tab_preview($settings)
    {
        ...
        <?php echo esc_attr($settings['call_action']); ?>
                        ...
                        <span class="tab-tooltip" data-title="<?php esc_attr_e('Pop up preview will be displayed in the "Pop Up Design" step', 'coupon-x'); ?>"></span>
                        <div class="tab-icon" >                            
                            <span class='icon-img'>
